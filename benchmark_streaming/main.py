...
Usage:
    ...
    python -m benchmark_streaming.main ./my_audio_dir --vad-model tenvad
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    g.add_argument("--chunk-ms", type=int, default=DEFAULT_CHUNK_MS,
                   help=("Chunk-size hint (default 32). Silero always uses 32 ms internally; "
                         "for WebRTC use --webrtc-frame-ms; TenVAD uses --tenvad-hop-size."))
